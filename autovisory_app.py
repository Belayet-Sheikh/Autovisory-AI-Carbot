# -*- coding: utf-8 -*-
"""autovisory_app.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1k3RJURx5BV_5Sq_wURK7NYhQbPgW2EuS
"""
...
def load_and_prepare_data():
    ...
    try:
        ...
        df_used_europe = pd.read_csv('data/car_prices.csv')
        ...
        st.error(f"ERROR: Missing data file - {e}. Make sure the 'data' folder with CSVs is in your repository.")
        st.stop()
